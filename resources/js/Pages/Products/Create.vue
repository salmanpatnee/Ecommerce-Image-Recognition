            ...
            <div class="flex flex-col items-center  pt-6 ">
                <div class="mb-5 w-full sm:max-w-md">
                    <form @submit.prevent="submit">
                        <div>
                            <TextInput id="name" class="w-full mb-4" v-model="form.name" placeholder="Product name" />
                            <InputError :message="form.errors.name" class="mt-1" />
                        </div>
                        <div>
                            <TextInput id="price" type="number" class="w-full mb-4" v-model="form.price"
                        ...
                        <div>
                            <select
                                ...
                                placeholder="Category" name="category_id" id="category_id" v-model="form.category_id">
